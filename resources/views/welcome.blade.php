...
<div class="container mx-auto px-4 py-16">
    <div class="max-w-3xl mx-auto bg-white shadow rounded-lg p-10 text-center">
        ...
        <div class="flex justify-center gap-4">
            <a href="{{ route('login') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded">
                Se connecter
            </a>
            <a href="{{ route('register') }}" class="border border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-2 rounded">
                S'inscrire
            </a>
        </div>
    </div>
